...
export default function ProfilePage() {
  ...
  // Note: createdAt is not available in the session user object.
  // To show "Membre depuis", we'd need to extend the NextAuth session types.
  // For now, we'll fetch it separately or skip it.

          ...
          <div key={category}>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {resources.filter(r => r.category === category).map((resource) => (
                <Card key={resource.id} className="hover:shadow-md transition-shadow border-2 hover:border-violet-400">
                  ...
                  <CardContent><span className="inline-flex items-center text-sm text-violet-400 font-medium cursor-default" title="Bientôt disponible">Bientôt disponible</span></CardContent>
                </Card>
              ))}
            </div>
          </div>
